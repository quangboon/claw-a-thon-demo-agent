...
class Settings(BaseSettings):
    ...
    # Lightweight access gate (prevents casual token-burning on the public endpoint).
    # Auth is ENABLED only when auth_password is non-empty; empty → open (dev/v1 behaviour).
